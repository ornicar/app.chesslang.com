  ...
  })()(
    {
      1: [
        function(require, module, exports) {
          ...
          var perf =
            window.performance !== undefined ? window.performance : Date
        ...
        function(require, module, exports) {
          ...
          function Chessground(element, config) {
            ...
            function redrawAll() {
              ...
              var elements = wrap_1.default(
                element,
                state,
                relative ? undefined : bounds()
              )
        ...
        function(require, module, exports) {
          ...
          function configure(state, config) {
            ...
            if (!state.movable.rookCastle && state.movable.dests) {
              ...
              if (!dests_1 || !king || king.role !== 'king') return
              state.movable.dests[kingStartPos] = dests_1.filter(function(d) {
                return (
                  !(
                    d === 'a' + rank_1 && dests_1.indexOf('c' + rank_1) !== -1
                  ) &&
          ...
          function start(s, e) {
            ...
            if (
              ...
              if (ghost) {
                ...
                util.translateAbs(
                  ghost,
                  util.posToTranslateAbs(bounds)(util.key2pos(orig), asWhite)
                )
          ...
          function processDrag(s) {
            util.raf(function() {
              ...
              if (!origPiece || !util.samePiece(origPiece, cur.piece)) cancel(s)
                ...
                if (
                  !cur.started &&
                  util.distanceSq(cur.epos, cur.rel) >=
                ...
                if (cur.started) {
                  ...
                  var translation = util.posToTranslateAbs(bounds)(
                    cur.origPos,
                    asWhite
                  )
      ...
      7: [
        function(require, module, exports) {
          ...
          function start(state, e) {
            ...
            var orig = board_1.getKeyAtDomPos(
              position,
              state.orientation === 'white',
              state.dom.bounds()
            )
          ...
          function processDraw(state) {
            util_1.raf(function() {
              ...
              if (cur) {
                var mouseSq = board_1.getKeyAtDomPos(
                  cur.pos,
                  state.orientation === 'white',
                  state.dom.bounds()
                )
        ...
        function(require, module, exports) {
          ...
          function bindDocument(s, redrawAll) {
            ...
            if (!s.dom.relative && s.resizable) {
              ...
              unbinds.push(
                unbindable(document.body, 'chessground.resize', onResize)
              )
            }
            if (!s.viewOnly) {
              ...
              unbinds.push(
                unbindable(window, 'scroll', onScroll, { passive: true })
              )
              unbinds.push(
      ...
      13: [
        function(require, module, exports) {
          ...
          function render(s) {
            ...
            for (var i in movedPieces) removeNodes(s, movedPieces[i])
            for (var i in movedSquares) removeNodes(s, movedSquares[i])
          }
          ...
          function removeNodes(s, nodes) {
            for (var i in nodes) s.dom.elements.board.removeChild(nodes[i])
          }
        ...
        function(require, module, exports) {
          ...
          function renderArrow(brush, orig, dest, current, shorten, bounds) {
            ...
            return setAttributes(createElement('line'), {
              ...
              'marker-end': isTrident
                ? undefined
                : 'url(#arrowhead-' + brush.key + ')',
              opacity: opacity(brush, current),
              x1: a[0],
              y1: a[1],
              x2: b[0] - xo,
      ...
      17: [
        function(require, module, exports) {
          ...
          exports.allKeys = (_a = Array.prototype).concat.apply(
            _a,
            cg.files.map(function(c) {
        ...
        function(require, module, exports) {
          ...
          function wrap(element, s, bounds) {
            ...
            if (s.coordinates) {
              ...
              element.appendChild(
                renderCoords(types_1.ranks, 'ranks' + orientClass)
              )
              element.appendChild(
